          ...
          <Card className="overflow-hidden">
            ...
            <CardPanel className="max-h-96 overflow-auto p-0">
              <Table>
                ...
                {/* Lista de URLs cadastradas para monitoramento */}
                <TableBody>
                  {list.map((m) => (
                    <TableRow
                      key={m.id}
                            ...
                            <div className="flex flex-col gap-2.5">
                              ...
                              {col.cards.map((card) => (
                                <article
                                  ...
                                  role="button"
                                  tabIndex={0}
                                  className={`group relative flex flex-col justify-between rounded-lg border bg-card p-3.5 text-left shadow-xs transition-all hover:border-primary/40 hover:shadow-sm outline-none focus-visible:ring-2 focus-visible:ring-ring ${card.resolved ? "opacity-65 bg-card/60 border-border/60" : ""
                                    }`}
                                  ...
                                  <div>
                                    <div className="flex items-start justify-between gap-2">
                                      <div className="flex items-center gap-1.5 min-w-0">
                                        ...
                                        <h4
                                          className={`break-words text-sm font-medium leading-snug ${card.resolved ? "line-through text-muted-foreground" : "text-foreground"
                                            }`}
                                        >
                                          {card.name}
                                        </h4>
